            ...
            <div class="container">
              ...
              <div class="collapse navbar-collapse justify-content-end" id="navbarNav">
                <ul class="navbar-nav">
                  ...
                  <li class="nav-item">
                    <a href="https://api.whatsapp.com/send?phone=+919560494030&amp;text=I am Interested in your services." class="nav-link btn_main btn_main_1">
                        Free SEO Audit
                    </a>
      ...
      <div class="hero_animation">
        ...
        <div class="container pt-4">
                    ...
                    <div class="home_content d-flex gap-3">
                      <!-- <div class="social_media">
                        ...
                        data-aos-duration="3000">
                          <h1 class="text-white">Get Your Website On <span> No. 1 Page Of Google </span></h1>
                          <h4 class="mt-3 mb-3 text-white">Boost your business growth with our results-driven SEO strategies.</h4>
                          ...
                          <a href="https://api.whatsapp.com/send?phone=+919560494030&amp;text=I am Interested in your services." class="btn_main text-decoration-none">Connect with us</a>
                        </div>
                    </div>
                </div>
                <div class="col-xl-6 col-md-6">
            ...
            <div class="image-container">
                <img src="/assets/media/images/logo/logo.webp" alt="Image">
            </div>
            <a href="https://api.whatsapp.com/send?phone=+919560494030&amp;text=I am Interested in your services." class="btn_main" style="margin-top:30px">
                <i class="fab fa-whatsapp" style="font-size:20px;margin-right:5px"></i>
                WhatsApp Now
            </a>
        </div>
        </div>
        ...
        <div class="row">
          <div class="col-xl-4 col-xl-4 mb-3 mb-xl-0" data-aos="fade-right" data-aos-offset="300" data-aos-easing="ease-in-sine">
            <div class="seo_type_content main_heading">
              ...
              <a href="https://api.whatsapp.com/send?phone=+919560494030&amp;text=I am Interested in your services." class="btn_main text-decoration-none">Contact Us</a>
            </div>
          </div>
          <div class="col-xl-8">
            <div class="row">
        ...
        <div class="row">
          ...
          <div class="col-xl-4 col-md-6 col-sm-6 mt-3" data-aos="fade-up" data-aos-duration="1000">
            <div class="rating_boxes">
              <div>
                <img src="./images/logo-white.png" alt="" class="w-100">
              </div>
      ...
      <div class="container our_companies_section">
        <div class="row">
          <div class="help_business_box text-center">
            ...
            <a href="https://api.whatsapp.com/send?phone=+919560494030&amp;text=I am Interested in your services." ><button class="border-0 btn_main mx-auto d-block">Get Free SEO consultation</button></a>
          </div>
        </div>
      </div>
    </section>
            ...
            <div class="seo_packages_box">
                ...
                <ul class="list-unstyled ">
                  ...
                  <div class="button_online d-flex mb-2 mt-4">
                    <a href="https://api.whatsapp.com/send?phone=+919560494030&amp;text=I am Interested in your services." class="btn_main text-decoration-none mx-auto">Talk to a Consultant</a>
                  </div>
                </ul>
            </div>
          </div>
...
.ht-60 {
    ...
    <div class="whatshapp_img">
      <a href="https://api.whatsapp.com/send?phone=+919560494030&amp;text=I am Interested in your services." class="btn-whatsapp-pulse btn-whatsapp-pulse-border">
