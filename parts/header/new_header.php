...
.sticky-header {
        ...
        @media (min-width: 769px) {
            ...
            .header-placeholder {
                display: block;
                height: 60px; /* Match the height of your top bar and navbar */
            }
        ...
        @media (max-width: 768px) {
            ...
            .header-placeholder {
                display: block;
                height: 60px; /* Adjust based on your mobile header height */
            }
...
@media (max-width: 768px) {
    ...
    .dropdown-menu {
        border-radius: 10px; /* Soften dropdown menu corners */
...
@media (max-width: 480px) {
    .nav-item {
        padding: 10px 0; /* More space between menu items */
    }
         ...
         <ul class="nav-menu">
            ...
            <li class="nav-item nav-new" >
               ...
               <ul class="dropdown-menu">
                  <li class="has-submenu me">
                     ...
                     <ul class="seo-submenu more-menu">
                        <li class="me">
            ...
            <li class="nav-item nav-new">
               ...
               <ul class="dropdown-menu">
                  ...
                  <li class="me"><img src="/assets/media/images/new/case-study.png" height="25px" width="25px" style="margin-right: -7px;margin-top: 10px;" alt="Case Study"><a href="https://www.acmeinfolabs.com/case-study" class="dropdown-item">Case Study</a></li>
