    ...
    <section class="case_study_section">
        <div class="container">
            <div class="row align-items-center">
                <div class="col-md-6 case_study_content text-sm-start text-center">
                    <h1 class="text-sm-start text-center">Case Stydy Acme Infolabs India</h1>
                    <p class="mt-3 text-sm-start text-center">We help you succeed online with proven SEO methods.</p>
                    <a href="contact-us"><button class="border-0 text-white mt-3">GET STARTED NOW</button></a>
                </div>
                <div class="col-md-6 d-sm-block d-none">
                    <div class="case-banner mt-md-0 mt-4">
                        <img src="./cast-study-img/casestudy-top-banner.png" alt=""class="w-100 mx-auto d-block">
                    </div>
                </div>
            </div>
        </div>
