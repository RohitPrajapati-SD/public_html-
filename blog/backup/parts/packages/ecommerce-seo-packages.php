<div class="ft_pakcge-div">
    ...
    <div class="normal-clmn">
        ...
        <div class="td"><p><i class="icon no"></i></p></div>
        <div class="td bg-blue"><p>INR 18,000</p></div>
        <div class="td bg-blue"><p>USD 270</p></div>
        <div class="button-clmn">
            ...
            <div class="ft-header"><span>Ecommerce SEO - Economy package</span>
            ...
            <div class="adForm">
               ...
               <input type="hidden" name="uPackage" value="Ecommerce SEO - Economy package">
                </form>
            </div>
            </div>
    ...
    <div class="star-clmn">
        ...
        <div class="td"><p>Email</p></div>
        <div class="td"><p><i class="icon no"></i></p></div>
        <div class="td bg-blue"><p>INR 23,000</p></div>
        <div class="td bg-blue"><p>USD 340</p></div>
        <div class="button-clmn">
            <!-- pop-up-button -->
            ...
            <div class="ft" id="ft2">
            <div class="ft-content">
            <div class="ft-header"><span>Ecommerce SEO - Silver package</span>
            <button class="icon ft-close">&times;</button>
            </div>
            <div class="ft-body">
            <div class="adForm">
                <form action="messages/order-received" method="post">    <!-- new Insert ---->
                <?php include('parts/forms/order-form.php'); ?>
               <input type="hidden" name="uPackage" value="Ecommerce SEO - Silver package">
                </form>
            </div>
            </div>
            <div class="ft-footer"><button class="link ft-close">close</button></div>
    ...
    <div class="normal-clmn">
        ...
        <div class="td"><p><i class="icon no"></i></p></div>
        <div class="td bg-blue"><p>INR 33,000</p></div>
        <div class="td bg-blue"><p>USD 470</p></div>
        <div class="button-clmn">
            <!-- pop-up-button -->
            ...
            <div class="ft" id="ft3">
            <div class="ft-content">
            <div class="ft-header"><span>Ecommerce SEO - Gold package</span>
            <button class="icon ft-close">&times;</button>
            </div>
            <div class="ft-body">
            <div class="adForm">
                <form action="messages/order-received" method="post">    <!-- new Insert ---->
                <?php include('parts/forms/order-form.php'); ?>
               <input type="hidden" name="uPackage" value="Ecommerce SEO - Gold package">
                </form>
            </div>
            </div>
            <div class="ft-footer"><button class="link ft-close">close</button></div>
    ...
    <div class="normal-clmn">
        ...
        <div class="td"><p>Email/Chat</p></div>
        <div class="td"><p><i class="icon no"></i></p></div>
        <div class="td bg-blue"><p>INR 50,000</p></div>
        <div class="td bg-blue"><p>USD 750</p></div>
        <div class="button-clmn">
            <!-- pop-up-button -->
            ...
            <div class="ft" id="ft4">
            <div class="ft-content">
            <div class="ft-header"><span>Ecommerce SEO - Platinum package</span>
            <button class="icon ft-close">&times;</button>
            </div>
            <div class="ft-body">
            <div class="adForm">
                <form action="messages/order-received" method="post">    <!-- new Insert ---->
                <?php include('parts/forms/order-form.php'); ?>
               <input type="hidden" name="uPackage" value="Ecommerce SEO - Platinum package">
                </form>
            </div>
            </div>
            <div class="ft-footer"><button class="link ft-close">close</button></div>
